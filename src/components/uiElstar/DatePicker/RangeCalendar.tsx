...
export interface RangeCalendarProps
  extends CommonProps,
    Omit<CalendarSharedProps, "value" | "isDateInRange" | "isDateFirstInRange" | "isDateLastInRange"> {
...
const RangeCalendar = forwardRef<HTMLDivElement, RangeCalendarProps>((props, ref) => {
  const { value, onChange, dayStyle, singleDate = false, dateViewCount = 1, paginateBy, ...rest } = props
