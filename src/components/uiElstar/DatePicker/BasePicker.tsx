...
import type { ReactNode, FocusEvent, HTMLInputTypeAttribute, KeyboardEvent, MouseEvent, ChangeEvent } from "react"
  ...
  return (
    <>
      <Input
        ...
        onChange={onChange}
      />
      <div ref={popperRef} className="picker" style={styles.popper} {...attributes.popper}>
