...
import Card from "@/components/uiElstar/Card"
import { LAYOUT_TYPE_MODERN } from "@/constants/theme.constant"
import type { CardProps } from "@/components/uiElstar/Card"
...
const AdaptableCard = (props: AdaptableCardProps) => {
  const { className, children, bodyClass, leftSideBorder, rightSideBorder, divider, shadow, isLastChild, ...rest } =
    props

  const type = useSelector((state: RootState) => state.theme.layout.type)
